    ...
    crates = {
      ...
      "provas 0.3.0" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "5a2645b4b8066409bb6cd365e2e85a57b7b13fdc";
          sha256 = "1ir2nvapdgf3dv7w250n1rpijxvgxyymiy26m9k2ip0jysgg9yvg";
        };
        authors = [
          "Pleme Team <team@pleme.io>"
        ];
      ...
      "tabeliao" = rec {
        ...
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/pleme-io/tabeliao";
          rev = "f962c904386633d161352c720cd20894e225c07d";
          sha256 = "1dss4450fbpp60bb93w3wlb9d544gw9abv0p7n3syvdah5xqf6b0";
        };
        authors = [
          "Pleme Team <team@pleme.io>"
        ];
